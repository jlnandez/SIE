	...
	<div id="container">
		<div class="row" style="background:url(./Content/img/texture.png)">
			...
			<div class="col-md-8" style="text-align: center">
				<header>
                    <h2 style="color: #007141">FACULTAD DE CIENCIAS ADMINISTRATIVAS</h2>
					<%--<h2 style="color: #007141">UNIVERSIDAD AUT&Oacute;NOMA DE BAJA CALIFORNIA</h2>--%>
					<h4>Sistema de Intercambio Estudiantil</h4>
				</header>
			</div>
		</div>
	</div>
...
<!-- 							</p> -->
					...
					<div class="col-lg-12">
						Para mejor funcionalidad del sistema se recomienda. <a href="http://www.google.com.mx/intl/es-419/chrome/"> <img id="logo"
				...
				<div class="col-xs-12 col-sm-offset-1 col-sm-5 col-md-offset-1 col-md-5 col-lg-offset-1 col-lg-4">
					<div class="box">
						<div class="form-group">
							<h3 class="col-lg-12 control-label" style="text-align: center">Soporte</h3>
						</div>
						
						<address class="text-left">
							<strong>Campus Mexicali</strong>
							<br/>- Nombre: Jose Luis Hern&aacute;ndez
							<br/>- Correo para soporte: a1100258@uabc.edu.mx
							<br/>-<abbr title="Tel&eacute;fono">Tel:</abbr>  (686)000-0000
						</address>
						<%--<address class="text-left">
							<strong>Campus Tijuana</strong>
							<br/>- Nombre: Ana Lidia G&aacute;mez Arredondo 
							<br/>- Correo para soporte: sifpvu.tij@uabc.edu.mx 
							<br/>-<abbr title="Tel&eacute;fono">Tel:</abbr>  (664)9797505 ext. 53623
						</address>--%>
...
<!-- 						<address class="text-left">
	...
	<div class="row">
		<input id="registro_ur_status" type="hidden" value="0"/> <input id="idUr" type="hidden"/>
		<div class="col-md-12" style="text-align: center; height: 150px;">
			<footer id="footer">
				...
				México 2019
				<br/>				
				<small>Actualizaci&oacute;n: 23 de Agosto de 2019</small>
				</p>
